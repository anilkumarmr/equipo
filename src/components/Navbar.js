...
import AddPatient from "./includes/AddPatient";
...
const Navbar = (props) => {
   ...
   const addPatient = () => {
      props.showAddPatient({ isVisible: true });
   };
   ...
   return (
      <>
         ...
         <AddPatient
            ...
            showAddPatient={props.showAddPatient}
            savePatient={props.addPatientRequest}
         />
      </>
   );
};
const mapStateToProps = (state) => {
   return {
      ...
      isVisible: state.patients.isVisible,
   };
};
...
const mapDispatchToProps = (dispatch) => {
   return {
      ...
      showAddPatient: (payload) => dispatch(showAddPatient(payload)),
      addPatientRequest: (payload) => dispatch(addPatientRequest(payload)),
   };
};
